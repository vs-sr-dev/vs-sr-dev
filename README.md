...
Two families are indexed **before** having any titles in them — 3DO and Dreamcast. Their checklists are scaffolds written from public documentation, marked `[unverified]` on every claim, and they exist so the first disc has a structure to be filed into and a set of questions to be measured against rather than a blank page. Nothing in either has been measured, and both say so at the top.
