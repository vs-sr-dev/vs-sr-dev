...
| [**pc-hurl-doc**](https://github.com/vs-sr-dev/pc-hurl-doc) | *H.U.R.L.* / *Slob Zone 3D* (Deep River Publishing, 1995) on Lary Myers' **ACK-3D** raycaster — levels that ship as commented ASCII source, naming 661 of the game’s 684 bitmaps by their original artist file names; a parser keyword table where capitalisation alone separates the engine’s keywords from the eleven the studio bolted on; every projectile in the game parked in a sealed room off the edge of the map, because the engine allocates nothing at run time — and a stale copy of level 2 sitting on the retail disc under another name |
| [**pc-mm-doc**](https://github.com/vs-sr-dev/pc-mm-doc) | *Might & Magic: Secret of the Inner Sanctum* (1987) |
| [**pc-nitemare3d-doc**](https://github.com/vs-sr-dev/pc-nitemare3d-doc) | *Nitemare-3D: A House of Horrors* (David P. Gray, 1994) — a one-man 256-colour shooter that owes **nothing** to Wolfenstein: every format is Gray's own and **none of it is compressed**, because the engine demand-pages its art through a three-tier cache (conventional RAM / XMS / disk) that keeps its own reload and thrash counters. Images are stored **column major**, a wall block carries **two different textures** rather than a light/dark pair, and the music is fifteen plain `.mid` files with a General MIDI soundbank. An artist's placeholder shipped in the retail data as a wall reading *"See file TILES007.PCX"* — unreachable, and 8 KB of it in every copy |
