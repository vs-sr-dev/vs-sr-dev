...
| Repo | What it is |
|---|---|
| [**cdi-platformnotes-doc**](https://github.com/vs-sr-dev/cdi-platformnotes-doc) | The canonical Philips CD-i platform checklist, shared by all the CD-i pipelines instead of forked into each — including the 29 seconds of authoring-system audio that turns up **byte-identical** on two unrelated 1993 discs |
